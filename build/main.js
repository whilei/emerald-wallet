...
var convert = __webpack_require__(23).convert;
var bodyStream = __webpack_require__(43);
...
var _followRedirects = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"follow-redirects\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
...
var _unzip = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"unzip2\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));

var _unzip2 = _interopRequireDefault(_unzip);

var _verify = __webpack_require__(21);
    ...
    _createClass(Downloader, [{
            ...
            return new Promise(function (resolve, reject) {
                _this.check_exists().then(function (is_exists) {
                    if (is_exists) {
                        ...
                        _this.backup().then(_this.downloadArchive.bind(_this)).then(_this.verifyArchive.bind(_this)).then(_this.unpack.bind(_this)).then(_this.cleanup.bind(_this)).then(resolve).catch(reject);
                    }
                });
            });
        }
        ...
        value: function downloadArchive() {
            ...
            return new Promise(function (resolve, reject) {
                ...
                _fs2.default.mkdtemp(_path2.default.join(tmpDir, 'download-' + _this2.name + '-'), function (err, folder) {
                    if (err) {
                    ...
                    _this2.tmp = folder;
                    _loglevel2.default.info('Download ' + _this2.name + ' from ' + targetUrl + ' to ' + folder + '/');
                    var f = _fs2.default.createWriteStream(folder + '/dest.zip');
        ...
        value: function unpack(zip) {
            ...
            return new Promise(function (resolve, reject) {
                _fs2.default.createReadStream(zip).pipe(_unzip2.default.Parse()).on('entry', function (entry) {
                    ...
                    if (entry.type === 'File' && fileName === _this3.name) {
                        var target = _path2.default.join('bin', fileName);
                        _loglevel2.default.info('Extract to ' + target + '...');
                        entry.pipe(_fs2.default.createWriteStream(target));
                        entry.on('end', function () {
                            _fs2.default.chmod(target, 493, function (err) {
                                if (err) {
                                    _loglevel2.default.error("Failed to set executable flag", target, err);
                                }
                            });
                        });
                    } else {
                        _loglevel2.default.debug('Skip ' + fileName);
                        entry.autodrain();
                    }
                }).on('close', function () {
                    resolve(true);
        ...
        value: function backup() {
            ...
            return new Promise(function (resolve, reject) {
                var target = 'bin/' + _this4.name;
                _fs2.default.access(target, _fs2.default.constants.F_OK, function (err) {
                    if (!err) {
                        var bak = _path2.default.join('bin', _this4.name + '.bak');
        ...
        value: function cleanup() {
            ...
            return new Promise(function (resolve, reject) {
                ...
                deleteIfExists(_this5.tmp + '/dest.zip').then(function () {
                    _fs2.default.rmdir(_this5.tmp, function (err) {
                        if (err) {
...
exports.launchGeth = launchGeth;
exports.launchEmerald = launchEmerald;

var _child_process = __webpack_require__(48);
...
function launchGeth() {
    _loglevel2.default.info("Starting Geth...");
    var bin = './bin/geth' + suffix;
    var options = ['--chain', 'morden', '--rpc', '--rpc-cors-domain', 'http://localhost:8000'];
    return (0, _child_process.spawn)(bin, options);
}

function launchEmerald() {
    _loglevel2.default.info("Starting Emerald Connector...");
    var bin = './bin/emerald-cli' + suffix;
    var options = ['--client-host', '127.0.0.1', '--client-port', '8545'];
    return (0, _child_process.spawn)(bin, options);
}
...
var _winLinux = __webpack_require__(20);

var _winLinux2 = _interopRequireDefault(_winLinux);
...
function createWindow(openDevTools) {
  ...
  exports.mainWindow = mainWindow = new _electron.BrowserWindow({ width: 800, height: 600 });
  ...
  menu = _electron.Menu.buildFromTemplate((0, _winLinux2.default)(mainWindow));
...
var emeraldMethods = ["eth_sendTransaction", "eth_accounts"];

var RpcApi = exports.RpcApi = function () {
    function RpcApi(urlEmerald, urlGeth) {
    ...
    _createClass(RpcApi, [{
        ...
        * @returns {Promise}
        */
        value: function call(name, params, headers) {
            var _this = this;

            return new Promise(function (resolve, reject) {
                _this.jsonPost(name, params, headers).then(function (json) {
        ...
        key: 'jsonPost',
        value: function jsonPost(name, params, headers) {
            var data = {
                jsonrpc: '2.0',
                method: name,
                params: params,
            ...
            var url = RpcApi.routeToEmerald(name) ? this.urlEmerald : this.urlGeth;
            return fetch(url, {
                method: 'POST',
        ...
        key: 'routeToEmerald',
        value: function routeToEmerald(method) {
...
var _mainWindow = __webpack_require__(17);

var _rpcApi = __webpack_require__(18);

var _launcher = __webpack_require__(16);

var _downloader = __webpack_require__(15);
...
_loglevel2.default.setLevel(isDev ? _loglevel2.default.levels.DEBUG : _loglevel2.default.levels.INFO);
...
global.rpc = new _rpcApi.RpcApi();

// This method will be called when Electron has finished
// initialization and is ready to create browser windows.
// Some APIs can only be used after this event occurs.
_electron.app.on('ready', function () {
    _loglevel2.default.info("Starting Emerald...");
    var gethDownloader = (0, _downloader.newGethDownloader)();
    gethDownloader.downloadIfNotExists().then(function () {
        var geth = (0, _launcher.launchGeth)();
        ...
        geth.stderr.on('data', function (data) {
            ...
            if (/HTTP endpoint opened/.test(data)) {
                _loglevel2.default.info('Geth RPC API is ready');
                (0, _mainWindow.createWindow)(isDev);
            }
        });
    ...
    var emerald = (0, _launcher.launchEmerald)();
...
_electron.app.on('activate', function () {
    ...
    if (_mainWindow.mainWindow === null) {
        (0, _mainWindow.createWindow)(isDev);
    }
});
...
var _kbpgp = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"kbpgp\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
...
module.exports = {
    ...
    'gbk': {
        type: '_dbcs',
        table: function() { return __webpack_require__(4).concat(__webpack_require__(9)) },
    },
    'xgbk': 'gbk',
    'isoir58': 'gbk',
...
var realFetch = __webpack_require__(45);
